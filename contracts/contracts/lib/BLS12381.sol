...
library BLS12381 {
    ...
    function bytesToG1Point(bytes calldata pointBytes) internal pure returns(G1Point memory point){
    ...
    function bytesToG2Point(bytes calldata pointBytes) internal pure returns(G2Point memory point){
