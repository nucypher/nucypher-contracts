...
VERIFY = False
CONSTRUCTOR_PARAMS_FILEPATH = CONSTRUCTOR_PARAMS_DIR / "tapir" / "root-signing-infra.yml"


def main():
    """
    This script deploys the Signing Infrastructure on Tapir/Sepolia.
    """
    ...
    # note: don't do this in mainnet deployment script; the deployer is not the initiator
    deployer.transact(
