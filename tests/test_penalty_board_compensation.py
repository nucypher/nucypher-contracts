...
@pytest.mark.parametrize("cadence", [(12,), (4, 5, 6, 7, 8, 9, 10, 11, 12)])
...
def test_turning_on_and_of_reward(
    penalty_board_comp,
    staking_provider,
    owner,
    beneficiary,
